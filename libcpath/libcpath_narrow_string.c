     ...
     libcerror_error_t **error )
{
	...
	static char *function  = "libcpath_narrow_string_split";
	...
	if( libcpath_narrow_split_string_initialize(
	     split_string,
	     string,
	     string_size,
	     number_of_segments,
	 ...
	 */
	if( libcpath_narrow_split_string_get_string(
	     *split_string,
	     &segment_start,
	     &string_size,
	     error ) != 1 )
	     ...
	     segment_index++ )
	{
		...
		if( segment_end == ( (libcpath_internal_narrow_split_string_t *) *split_string )->string )
		{
			segment_start++;
		}
		if( segment_end != ( (libcpath_internal_narrow_split_string_t *) *split_string )->string )
